...
<section class="page-hero">
  ...
  <h1>AI, business, and society</h1>
</section>

<section class="course-section">
  <div class="course-sidebar">
    <p class="section-label">OIDD 2550</p>
    <p class="course-status">Not offered in the 2026-2027 academic year</p>
  </div>
  ...
  <div class="course-content">
    ...
    <div class="topic-list" aria-label="Course topics">
      <div class="topic-item">Model bias</div>
      <div class="topic-item">Algorithm interpretability</div>
      <div class="topic-item">Data assets and market power</div>
      <div class="topic-item">AI ethics</div>
      <div class="topic-item">AI and the future of work</div>
      <div class="topic-item">Organizational adoption</div>
    </div>
  </div>
</section>
